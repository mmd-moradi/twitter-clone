...
const Modal: React.FC<ModalProbs> = ({
  ...
  return (
    <>
        ...
        ">
            <div className="relative w-full lg:w-5/12 my-6 mx-auto lg:max-w-3xl h-full lg:h-1/12 pt-10">
                {/* Content */}
                <div className="h-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-black outline-none focus:outline-none">
                    ...
                    <div className="flex flex-col gap-2 p-10">
                        <Button disabled={disabled} label={actionLabel} secondarey fullwidth large onClick={handleSubmit} />
                        {footer}
                    </div>
                </div>
            </div>
